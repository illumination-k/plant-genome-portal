use epigenome_domain::{EpigenomeError, ExperimentId};
use expression_domain::ExpressionError;
use genome_domain::DomainError;
...
pub enum EpigenomeStoreError {
    ...
    #[error("expression-domain domain error: {0}")]
    Expression(#[from] ExpressionError),
    #[error("genome-domain domain error: {0}")]
