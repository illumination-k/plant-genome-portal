...
export type FunctionalAnnotation =
  | (InterProAnnotation & {
      kind: "inter_pro";
    })
  | (PfamAnnotation & {
...
export type JbrowseChromSizesResponse =
  JbrowseChromSizesResponses[keyof JbrowseChromSizesResponses];
...
export type JbrowseDefaultConfigError =
  JbrowseDefaultConfigErrors[keyof JbrowseDefaultConfigErrors];
...
export type JbrowseDefaultConfigResponse =
  JbrowseDefaultConfigResponses[keyof JbrowseDefaultConfigResponses];
...
export type RefgetServiceInfoResponse =
  RefgetServiceInfoResponses[keyof RefgetServiceInfoResponses];
...
export type EpigenomeExperimentResponse =
  EpigenomeExperimentResponses[keyof EpigenomeExperimentResponses];
...
export type EpigenomeExperimentsError =
  EpigenomeExperimentsErrors[keyof EpigenomeExperimentsErrors];
...
export type EpigenomeExperimentsResponse =
  EpigenomeExperimentsResponses[keyof EpigenomeExperimentsResponses];
...
export type ExpressionClustergramError =
  ExpressionClustergramErrors[keyof ExpressionClustergramErrors];
...
export type ExpressionClustergramResponse2 =
  ExpressionClustergramResponses[keyof ExpressionClustergramResponses];
...
export type AssemblySequencesResponse =
  AssemblySequencesResponses[keyof AssemblySequencesResponses];
